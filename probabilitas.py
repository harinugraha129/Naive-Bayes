...
def get_probability(X,Y,keterangan):
...
get_probability(X,Y,"Probabilitas Dataset")
get_probability(X_train,Y_train,"Probabilitas Data Training")
get_probability(X_test,Y_test,"Probabilitas Data Testing")
